...
Keep target 192.0.2.10.
Keep scope 192.0.2.0/24.
Press Start.
Watch per-phase logs in Live Console.
Review findings and cracked passwords.
Open the generated HTML report from Reports.
The mock run emits:
